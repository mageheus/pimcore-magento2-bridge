...
{
    public const TYPE = MapperHelper::OBJECT_BRICKS_TYPE;
    public const ALLOWED_TYPES_ARRAY = MapperHelper::OBJECT_BRICKS_TYPES;
     ...
     */
    public function __construct(protected MapperContext $mapperContext, TranslatorInterface $translator)
    {
