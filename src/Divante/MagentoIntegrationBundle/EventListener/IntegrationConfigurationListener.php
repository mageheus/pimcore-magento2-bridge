...
class IntegrationConfigurationListener
{
    ...
    {
        $getProductMapping = $object->getProductMapping();
        ksort($getProductMapping);
        $getCategoryMapping = $object->getCategoryMapping();
        ksort($getCategoryMapping);
        ...
        foreach ($sameServiceIntegrations as $sameServiceIntegration) {
            ...
            $getProductMapping2 = $sameServiceIntegration->getProductMapping();
            ksort($getProductMapping2);
            $getCategoryMapping2 = $sameServiceIntegration->getCategoryMapping();
            ksort($getCategoryMapping2);
