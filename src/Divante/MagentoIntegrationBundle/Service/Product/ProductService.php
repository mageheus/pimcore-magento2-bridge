...
class ProductService extends AbstractObjectService
{
     ...
     * @throws \Exception
     */
    protected function processObject(DataObject\Concrete $object, AbstractObjectRequest $request): array|\stdClass
    {
    ...
    protected function getMappedObject(DataObject\Concrete $object, $out, $configuration): \stdClass
    {
        ...
        if (
            ...
            && !($object->getParent()::class == $object::class)
        ) {
        ...
        } elseif ($object->getParent()::class == $object::class) {
